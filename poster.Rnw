...
p1 <- plot_dpcrtest(test1stats) + ggtitle("1000 partitions")
p2 <- plot_dpcrtest(test2stats) + ggtitle("2000 partitions")
p3 <- plot_dpcrtest(test3stats) + ggtitle("5000 partitions")
